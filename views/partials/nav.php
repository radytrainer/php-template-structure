        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/team" class="<?= urlIs('/team') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700'; ?> hover:text-white px-3 py-2 rounded-md text-sm font-medium">Team</a>

              <a href="/project" class="<?= urlIs('/project') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700'; ?> hover:text-white px-3 py-2 rounded-md text-sm font-medium">Projects</a>
